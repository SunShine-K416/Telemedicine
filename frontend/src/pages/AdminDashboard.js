            ...
            <div className="dashboard-overview">
              <div className="stats-cards">
                <div className="stats-card">
                  ...
                  <Link to="/admin-dashboard/appointments" className="stats-link">
                    View All
                  </Link>
                </div>
                <div className="stats-card">
                  ...
                  <Link to="/admin-dashboard/prescriptions" className="stats-link">
                    Review
                  </Link>
                </div>
                <div className="stats-card">
                  ...
                  .map(appointment => (
                    <div key={appointment._id} className="appointment-card">
                      ...
                      <div className="appointment-actions">
                        <Link 
                          to={`/admin-dashboard/appointments/${appointment._id}`}
